...
{
	{
		DCore::ReadWriteLockGuard guard(DCore::LockType::WriteLock, *static_cast<DCore::PhysicsMaterialAssetManager*>(&DCore::AssetManager::Get()));
...
{
	// TODO. Atualizar o asset em memória volátil.
